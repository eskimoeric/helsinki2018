...
exports.LinkStyle = exports.Code = exports.Text = exports.ListItemLabel = exports.ListItem = exports.List = exports.Section = exports.OutputContainer = exports.Container = undefined;
...
var ListItemLabel = exports.ListItemLabel = (0, _reactEmotion2.default)('span')(_templateObject6, _variables.palette.grayLightest);

var Text = exports.Text = (0, _reactEmotion2.default)('p')(_templateObject7, (0, _propStyles2.default)({
...
var Code = exports.Code = (0, _reactEmotion2.default)('span')(_templateObject8);

var LinkStyle = exports.LinkStyle = (0, _reactEmotion2.default)('span')(_templateObject9, _variables.palette.grayLighter);
...
var _formElements = __webpack_require__(40);

var _CardLoad = __webpack_require__(41);

var _CardLoad2 = _interopRequireDefault(_CardLoad);

var _OutputBox = __webpack_require__(42);
...
var RightSide = function RightSide(props) {
  //<Link to="http://korsimoro.com">About Korsimoro</Link><br />
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
    ...
    processQueryStringInit: function processQueryStringInit(location) {
      ...
      if (searchParams.get('sn')) {
        ...
        if (searchParams.get('cmd') === 'hello') {
          ...
          var lookup = searchParams.get('lookup');
          if (lookup) {
            console.log("LOOKUP");
            dispatch((0, _reduxForm.change)('lookupForm', 'lookup', lookup));
            if (lookup === 'card') dispatch((0, _index.lookupCard)(dispatch, searchParams.get('sn')));else if (lookup === 'map') dispatch((0, _index.lookupMap)(dispatch, searchParams.get('sn')));else dispatch((0, _index.lookupDDO)(dispatch, 'h18', searchParams.get('sn')));
          } else {
...
var _TextLink = __webpack_require__(7);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _TextLink2.default,
            { to: 'https://en.wikipedia.org/wiki/Korsimoro_Department' },
            'Korsimoro'
          ),
          ' is both a town and district in ',
          _react2.default.createElement(
            _TextLink2.default,
            { to: 'https://en.wikipedia.org/wiki/Burkina_Faso' },
            'Burkina Faso'
          ),
          ', just outside of ',
          _react2.default.createElement(
            _TextLink2.default,
            { to: 'https://en.wikipedia.org/wiki/Ouagadougou' },
            'Ougadougou'
          ),
          ', which, until 2017, hosted ',
          _react2.default.createElement(
            _TextLink2.default,
            { to: 'https://en.wikipedia.org/wiki/Panafrican_Film_and_Television_Festival_of_Ouagadougou' },
            'FESPACO'
          ),
          '.  The region has been inhabited for nearly 20,000 years and my travels there in the 1990\'s were an eye opening experience which fundamentally changed the course of my life and my understanding of humanity.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'I will forever remember sitting in a household of four children, amidst a totality of possessions that could be purchased, in their entirety, for less than the tip on a wall street friday night bar bill, laughing the night away while consuming 1/2 of the family\'s livestock during a dinner honoring our visit.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'In rememberance of that Burkinabe night, and for a cost far exceeding the price of the single chicken we consumed, I registered the name of a nearby town, Korsimoro, as a ',
          _react2.default.createElement(
            _TextLink2.default,
            { to: 'http://korsimoro.com' },
            'domain'
          ),
          ' and have used it to organize projects supporting the digital and decentralized identity community.'
        )
      ),
      _react2.default.createElement(
        'dt',
        null,
        'Helsinki 2018, August'
      ),
      _react2.default.createElement(
        'dd',
        null,
        _react2.default.createElement(
          'p',
          null,
          'Korsimoro was started in 2015 as a way of organizing assorted dialogues and research around the state of digital identity.  We were on hiatus during most of 2017 and early 2018.  However, providence and serendepity conspired to renew our efforts during Q3 and Q4 of 2018, and specifically at MyData2018 and the associated Sovrin Trust Framework meetings.'
        )
      ),
      _react2.default.createElement(
        'dt',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'If you are here you most likely scanned the QR code on the back of an H18 Business Card.  These cards are part of what we call the \xA0',
          _react2.default.createElement(
            'i',
            null,
            'levity of identity'
          ),
          '. Click the link above to read more about the H18 cards.'
        )
      ),
      _react2.default.createElement(
        'dt',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Our interest in DID Resolution grew out of work with Southeast Asian and African financial institutions and markets in 2016.  We realized that participation in the global identity platforms was ill suited to the reality of identity in these contexts and was directly at odds with the need to keep jurisdictional data physically within political boundaries and operating only upon sanctioned hardware.  We found very few conservative institutions interested in pinning sensitive political and financial information to chains such as ethereum or bitcoin, or even the global Sovrin network.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'However, the value of co-opetitive decentralization within each jurisdiction was clear and remains of interest.  As such we began investigating an internet-of-identity model, whereby jurisdictions could run restricted versions of decentralized identity engines yet, through appropriate DID mechanics, could remain fully and seamlessly interoperable with the maturing suite of global identity solutions.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'We believe that the emergence of domain specific trust frameworks in STF2 is the realization of the Jurisdictional Trust Frameworks we promoted at that time.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'With the development of a robust platform for DID resolution in the ',
          _react2.default.createElement(
            _TextLink2.default,
            { to: 'https://github.com/decentralized-identity/universal-resolver' },
            'Universal Resolver'
          ),
          ' project, we see value in serving as a deployment testbed, specifically focused on'
        ),
        _react2.default.createElement(
          'ol',
          null,
          _react2.default.createElement(
            'li',
            null,
            'Making an instance of a universal resolver trivial to install and maintain'
          ),
          _react2.default.createElement(
            'li',
            null,
            'Enabling the rapid deployment of test methods pinned to internal systems'
          )
        ),
        _react2.default.createElement(
          'p',
          null,
          'We hope that this work will foster widespread adoption of the DID strategy and help bridge the gap between managed and decentralized identity environments.'
        )
      ),
      _react2.default.createElement(
        'dt',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Every identity system involves a legally binding trust framework, whether explicitly presented as in the case of the Sovrin Trust Framework, or implicit in the governing jurisdiction\'s legal and privacy management legislation.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'By combining visualization tools with a rich set of test cases we believe we can illustrate the effect of specific trust frameworks on the integrity of the web of trust they enable.  In so doing we can provide a valuable tool for communicating the impact of specific legislation or the adoption of alternative trust frameworks.'
        ),
        _react2.default.createElement(
          'p',
          null,
          'The ability to test-drive reputation metrics against an active suite of test cases is another valuable tool for the community. Reputation systems are easy to grasp intuitively, but they are hard to reason about objectively.  We see value in the ability to visualize reputation dynamics, and the effects of good and bad actors, as one evaluates alternative reputation metrics.'
        )
      )
    )
  );
...
var columnize = (0, _reactEmotion.css)(_templateObject);
/*
const columnize = css`
    column-count: 4;
    column-width: 320px;
...
var society = [{ count: 1, title: "Banker" }, { count: 1, title: "Customs Director" }, { count: 1, title: "Digital Identity Director" }, { count: 1, title: "Factory Owner" }, { count: 1, title: "General" }, { count: 1, title: "Head Monk" }, { count: 1, title: "Hospital Director" }, { count: 1, title: "Immigration Chief" }, { count: 1, title: "Importer" }, { count: 1, title: "Judge" }, { count: 1, title: "King" }, { count: 1, title: "Mayor" }, { count: 1, title: "Police Chief" }, { count: 1, title: "Prince" }, { count: 1, title: "Princess" }, { count: 1, title: "Queen" }, { count: 1, title: "School Director" }, { count: 1, title: "Tax Collector" }, { count: 2, title: "Doctor" }, { count: 2, title: "Lawyer" }, { count: 2, title: "Teacher" }, { count: 3, title: "Shop Owner" }, { count: 4, title: "Factory Worker" }, { count: 4, title: "Novice Monk" }, { count: 4, title: "Nurse" }, { count: 7, title: "Buffalo" }, { count: 8, title: "Bureaucrat" }, { count: 8, title: "Legal Immigrant" }, { count: 8, title: "Refugee" }, { count: 10, title: "Police Officer" }, { count: 10, title: "Soldier" }, { count: 14, title: "Child" }, { count: 24, title: "Farmer" }];
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _TextLink2.default,
          { to: '/about/resolver' },
          'DID Resolution toy method'
        ),
        ', pointing to a managed identity system, which represents a classic IAM honeypot.'
      ),
      _react2.default.createElement(
        'li',
        null,
        'A Domain Specific Trust Framework built upon the Sovrin Foundational Trust Framework'
      ),
      _react2.default.createElement(
        'li',
        null,
        'A small data store of card information fronted by a small webapp.'
      ),
      _react2.default.createElement(
        'li',
        null,
        'Metadata associated with each identity which trace the evolution of ownership, dependency and guardianship through time.'
      )
    ),
    _react2.default.createElement(
      'h4',
...
var AboutUseCases = function AboutUseCases(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'h4',
      null,
      'Reference Identity Pool & Use Case Definitions'
    ),
    _react2.default.createElement(
      'p',
      null,
      'Analysis of real world identity problems can be incredibly complicated.  There are about',
      _react2.default.createElement(
        _TextLink2.default,
        { to: 'https://en.wikipedia.org/wiki/World_population' },
        '7.6 Billion'
      ),
      'people on the planet, yet if you attend any working group call in identity community, you tend to hear about ',
      _react2.default.createElement(
        _TextLink2.default,
        { to: 'https://en.wikipedia.org/wiki/Alice_and_Bob' },
        'Alice and Bob'
      ),
      ', although sometimes the expanded',
      _react2.default.createElement(
        _TextLink2.default,
        { to: 'https://en.wikipedia.org/wiki/Alice_and_Bob#Cast_of_characters' },
        'Cast of Characters'
      ),
      ' comes out to play.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'This ensemble is incredibly useful for talking about message exchange and privacy preservation, but it does little to structure conversation about non-messaging identity issues, such as depedency, guardianship, and ownership.  Furthermore, the characters represent roles in processes, and are not up to the task of structuring the reference cases requried to perform objective, cross-identity system comparisons, or evaluation of legal frameworks such as the Sovrin Trust Framework and domain specific trust frameworks.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'The Sovrin Trust Framework introduces concepts of Ownership, Dependency, Guardianship, and the fact that Organizations, while having identity, can only influence the world through the actions of individuals.  Other trust frameworks, such as those operated by governments and regulatory agencies tend to be overly simplistic, and issues of ownership (such as the titling of an automobile) is bound into the bureaucratic spaghetti mess of auto financing, insurance, and credit bureaus.  Establishing a clear path to ownership and liability is an arduous and expensive task if the situation does not fall into one of the cookie-cutter patterns expected by the participating institutions.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'We see value in enumerating and documenting these sorts of cases, and developing the ability to replay them against test networks and trust frameworks.  When combined with visualization of the resulting trust graphs, these use cases will provide a powerful tool for non-technical debugging.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'It is important to stress that we are not talking about test cases used to verify the technical operation of a message passing and secure communications system, as Alice, Bob, and the Cast of Characters are adequate to this task. Rather, we are talking about real world situations and the content of claims and actions relative to the soft, real world goals.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'For example, I recently discovered that Equifax was reporting significantly out of date information about me.  This was curious because I have not had credit accounts in the United States for a long while.  Attempting to engage Equifax to change the information was not possible due to their existing tools and procedures, which could not handle my identity constellation.  My identity verification was blocked, not because of accuracy, but because their data system could not accept my information without throwing exceptions.  A similar situation had caused Equifax to reject updates to my information - they were simply dropping records. Because of this, for quite some time and without my knowledge, Equifax had become an errant verifier, unable to fulfill their obligation to truthfully report information about me.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'My Equifax issue reminds us that\xA0',
      _react2.default.createElement(
        'i',
        null,
        'digital identity solutions will always be deployed against a backdrop of corporate, governmental, and bureaucratic incompetence.'
      ),
      '  What exactly happens when a trust claim, which is cryptographically provably correct in the world, is nevertheless mishandled by a bungling bureaucracy.  Can we visualize what happens to a trust network when a botched IT update results in claims verifiers producing incorrect verifications?  Can we use this visualization to tune and debug the non-technical policy of the trust framework?'
    ),
    _react2.default.createElement(
      'p',
      null,
      'Reputation systems will come in to play, when dealing with large institutions the reputation of the verifier will only be impacted in the event of a large breach while individual participants can be substantially and negatively affected until the crisis grows large.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'It is important to stress that these issues are not issues of failed cryptography or privacy compromise.  These are not issues of secure communications or protected data storage, or even of authentication and authorization.  These are the qualitative issues that impact trust in the web of trust itself.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'In order to sustain our trust in the web of trust itself, the trust frameworks and legislation which back them must support the identity owners at the expense of largely broken corporations, governments, and regulatory institutions.  If we fail to do so we will have only changed the technology of identity and the details of the identity problems we continue to face.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'The use of trust-web visualization and the ability to replay test suites is an essential tool for ensuring that digital and decentralized identity make real, qualitative changes in the system of trust in which we are embedded.'
    )
  );
};
...
var AboutUniversalResolver = function AboutUniversalResolver(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'As part of Korsimoro\'s operations assessment, we are deploying an independent instance of universal resolver code base.  As part of the project we are adding a toy resolver for a local, unsanctioned, toy method - the ',
      _react2.default.createElement(
        _basicElements.Code,
        null,
        'h18'
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'li',
        null,
        'Allow us to document and fix any bugs and submit pull requests'
      ),
      _react2.default.createElement(
        'li',
        null,
...
var _Contour = __webpack_require__(63);
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 22)), (0, _importCss3.default)('src/containers/about/AboutH18Cards', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 23)), (0, _importCss3.default)('src/containers/about/AboutUseCases', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 24)), (0, _importCss3.default)('src/containers/about/AboutUniversalResolver', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var CardLoad = function CardLoad(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            _reactStatic.Link,
            { to: '/about/h18cards' },
            'Read more about the Helsinki 2018 cards.'
        ),
        _react2.default.createElement('br', null)
    );
};
...
var _MapDisplayBox = __webpack_require__(49);

var _MapDisplayBox2 = _interopRequireDefault(_MapDisplayBox);

var _CardDisplayBox = __webpack_require__(55);
...
var _reactJsonPretty = __webpack_require__(8);

var _reactJsonPretty2 = _interopRequireDefault(_reactJsonPretty);

var _H18Card = __webpack_require__(50);

var _H18Card2 = _interopRequireDefault(_H18Card);

var _Guardianship = __webpack_require__(51);

var _Guardianship2 = _interopRequireDefault(_Guardianship);

var _Dependency = __webpack_require__(52);

var _Dependency2 = _interopRequireDefault(_Dependency);

var _Organization = __webpack_require__(53);

var _Organization2 = _interopRequireDefault(_Organization);

var _Pet = __webpack_require__(54);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            'People routinely register their pets with an identity service by implanting them with an RFID source placed under the skin.  This sort of identity tagging is fragmented and distributed across many registries.  This is a classic area for identity management.'
          )
        ),
        _react2.default.createElement(
          'dt',
          null,
          'Dependency/Ownership/Guardianship'
        ),
        _react2.default.createElement(
          'dd',
          null,
          _react2.default.createElement(
            'p',
            null,
            'A pet is owned and is a dependent.  How do the nascent trust frameworks apply, given that they are generally focused on people.  Unlike a person, a pet is forever an owned and dependent entity - it will not suddenly graduate to ',
            _react2.default.createElement(
              _basicElements.Code,
              null,
              '#adulting'
            ),
            ' and take ownership of it\'s PKI.'
          )
        ),
        _react2.default.createElement(
          'dt',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            'The cat in the picture above once moved to the United States, and within the first week gave birth to one live kitten.  The birth was complicated and a littermate died without being delivered.  This required immediate surgery to the tune of $1500, for which we paid via a specially targetted pet care credit card.'
          ),
          _react2.default.createElement(
            'p',
            null,
            'The pet insurance industry (for example',
            _react2.default.createElement(
              _TextLink2.default,
              { to: 'https://www.petinsure.co/' },
              'Petinsure.co'
            ),
            ',',
            _react2.default.createElement(
              _TextLink2.default,
              { to: 'https://www.petinsurance.com/' },
              'Petinsurance.com'
            ),
            ') is an obvious case for integrations with non-human digital identity.'
          )
        )
      )
    )
...
var CardDisplay = function CardDisplay(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'Your card should look like the one below.  The card in your hand is an ',
      _react2.default.createElement(
        'i',
        null,
        'identity playing card'
      ),
      '.  Each card has an identity, space to acquire and grow and cardly biometric, and a generational counter along the bottom.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'In Cardish Society, you are a ',
      _react2.default.createElement(
        _basicElements.Code,
        null,
        profile.title
      ),
      ', but what exactly this means, is determined by the Cardish Trust Framework, a Domain Specific Trust Framework derived from the Sovrin Trust Framework.'
    ),
    _react2.default.createElement(
      'p',
      null,
      'Born in August 2018, this web site will continue to grow to support some fun interactions with these cardish identities during September and October of 2018.  Feel free to drop a line to the email listed on the front of the card for more information or just to say hello.'
    ),
    _react2.default.createElement(
      _reactStatic.Link,
      { to: '/about/h18cards' },
...
var _reduceReducers = __webpack_require__(59);
...
var _qrcode = __webpack_require__(61);
