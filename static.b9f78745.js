...
var _basicElements = __webpack_require__(13);
...
About = (0, _reactRedux.connect)(function (state) {
...
var Home = function (_Component) {
    ...
    function Home() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), _this), _this.getParams = function (location) {
            var dispatch = _this.props.dispatch;

            var searchParams = new URLSearchParams(location.search);
            if (searchParams.get('sn')) {
                dispatch((0, _reduxForm.change)('lookupForm', 'sn', searchParams.get('sn')));
                dispatch((0, _index.lookupMap)(dispatch, searchParams.get('sn')));
            }
...
exports.ListItem = exports.List = exports.H1 = exports.Text = exports.Article = exports.Section = exports.Container = undefined;
...
var _propStyles = __webpack_require__(14);
...
var Article = exports.Article = (0, _reactEmotion2.default)('article')(_templateObject3, _polished.clearFix);
...
var H1 = exports.H1 = (0, _reactEmotion2.default)('h1')(_templateObject5, (0, _propStyles2.default)({
    textSm: [_utilities.text.small],
    textMd: [_utilities.text.medium],
    textMdLg: [_utilities.text.mediumLg],
    textLg: [_utilities.text.large],
    ...
    upperCase: [_utilities.text.upperCase]
}), (0, _polished.transparentize)(0.5, _variables.palette.greenDarkest));

var List = exports.List = (0, _reactEmotion2.default)('ul')(_templateObject6, (0, _propStyles2.default)({
    noBullet: [_utilities.list.none],
    square: [_utilities.list.square],
    bullet: [_utilities.list.bullet]
}));

var ListItem = exports.ListItem = (0, _reactEmotion2.default)('li')(_templateObject7, (0, _polished.rem)('18px', '16px'));
...
var lookupDDO = function lookupDDO(dispatch, method, sn) {
...
var AboutH18Cards = function AboutH18Cards(props) {
  return _react2.default.createElement(
    ...
    'It turns out that many things which have identities are not smart phones and lack both human biometrics and secure cryptographic co-processing enclaves.  They lack GPS tracking signals, and you can not easily run their fingerprints through an AFIS system.',
    _react2.default.createElement('br', null),
    'Despite these limitations, the cards continue to exist - quite happily - sitting and carding around with their cardly friends, hanging out in wallets and on desktops, nestled down in the cracks of sofa cushions or resting, forgotten on taxi seats or the tables of conference venues.',
    _react2.default.createElement('br', null),
    'Every one of these cards was born at',
    _react2.default.createElement(
      'a',
      { href: 'http://www.nuntapun.com/' },
      'Nuntapun Printing'
    ),
    ' (which is',
    _react2.default.createElement(
    ...
    ') and they are destined to travel the world before becoming irrelevant, lost, or discarded.  which is the nature of cardish death.',
    _react2.default.createElement('br', null),
    'It is simply not easy enough to model the life of these cards, to track an honor their brief existence, given the tools available to digital and decentralized identity systems.  They are the forgotten, the disenfranchised, the discluded identities.',
    _react2.default.createElement('br', null),
    'Yet, as perhaps the simplest reference case in the world, and in the pursuit of card/human relations, we at Korsimoro aim to change this. Along the way we hope to learn a lot about the world of DIF and understand which tools are card-positive, and which are cardist, which support limited identities lacking smart-devices and the ability to access the internet and express agency over their private keys.',
    _react2.default.createElement('br', null),
...
var AboutUniversalResolver = function AboutUniversalResolver(props) {
  return _react2.default.createElement(
    ...
    'DID document resolution is defined per method, and involves a wide range of different technologies.',
    _react2.default.createElement('br', null),
    'The ',
    _react2.default.createElement(
      'a',
      { href: 'https://github.com/decentralized-identity' },
      'DIF\'s source repository.'
    ),
    ' contains a universal resolver, with a front end that can be used a ',
    _react2.default.createElement(
      'a',
    ...
    '.',
    _react2.default.createElement('br', null),
    'As part of Korsimoro\'s operations assessment, we are setting up a separate instance of universal resolver code base, and adding a toy resolver for the ',
    _react2.default.createElement(
      'a',
      { href: '/about/h18method' },
      'h18 toy'
    ),
    ' method.  This work is effectively a QA/testing exercise, with an eye towards making these complicated toolkits easier to use.  We hope that, in so doing, we can incubate interest and action outside of the immediate DIF community.',
    _react2.default.createElement('br', null),
    'This effort will:',
    _react2.default.createElement(
      'ol',
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 17)), (0, _importCss3.default)('src/containers/about/AboutIndex', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 18)), (0, _importCss3.default)('src/containers/about/AboutH18', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 19)), (0, _importCss3.default)('src/containers/about/AboutH18Cards', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 20)), (0, _importCss3.default)('src/containers/about/AboutUseCases', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 21)), (0, _importCss3.default)('src/containers/about/AboutH18Method', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/korsimoro/Desktop/korsimoro/repos/iglu/h18/react-site/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 22)), (0, _importCss3.default)('src/containers/about/AboutUniversalResolver', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            {
                                greenOutline: true,
                                disabled: pristine || submitting || activeMethod !== 'h18',
                                onClick: handleSubmit(function (values) {
                                    return onSubmit(_extends({}, values, {
                                        lookup: 'map'
                                    }));
                                })
                        ...
                        _react2.default.createElement(
                            ...
                            {
                                greenOutline: true,
                                disabled: pristine || submitting || formValues.sn === '',
                                onClick: handleSubmit(function (values) {
                                    return onSubmit(_extends({}, values, {
                                        lookup: 'ddo'
                                    }));
...
var _propStyles2 = __webpack_require__(14);
...
var _ServerError = __webpack_require__(46);

var _ServerError2 = _interopRequireDefault(_ServerError);

var _NotSupported = __webpack_require__(47);

var _NotSupported2 = _interopRequireDefault(_NotSupported);

var _Welcome = __webpack_require__(48);

var _Welcome2 = _interopRequireDefault(_Welcome);

var _CardLoad = __webpack_require__(49);

var _CardLoad2 = _interopRequireDefault(_CardLoad);

var _MapDisplayBox = __webpack_require__(50);
...
var OutputBox = function OutputBox(props) {
  ...
  if (qrcode.card_load) {
    return _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(_CardLoad2.default, null),
...
var _reactObjectInspector = __webpack_require__(45);
...
function getHeader(type) {
  if (type === 'ddo') {
    return _react2.default.createElement(
      'span',
      null,
      'The DID Document can be browsed below.'
    );
  }
  return _react2.default.createElement(
    'span',
...
var CardLoad = function CardLoad(props) {
    return _react2.default.createElement(
        'div',
        null,
        'You have likely arrived here by scanning the QR code on one of the business cards handed out in Helsinki, part of the MyData conference.',
        _react2.default.createElement('br', null),
        'More information about these cards is ',
        _react2.default.createElement(
            'a',
            { href: '/about/h18cards' },
            'here.'
...
var _reactJsonPretty = __webpack_require__(5);

var _reactJsonPretty2 = _interopRequireDefault(_reactJsonPretty);

var _H18Card = __webpack_require__(51);

var _H18Card2 = _interopRequireDefault(_H18Card);

var _Guardianship = __webpack_require__(52);

var _Guardianship2 = _interopRequireDefault(_Guardianship);

var _Dependency = __webpack_require__(53);

var _Dependency2 = _interopRequireDefault(_Dependency);

var _Organization = __webpack_require__(54);

var _Organization2 = _interopRequireDefault(_Organization);

var _Pet = __webpack_require__(55);
...
var Organization = function Organization(props) {
  ...
  var id = form.lookupForm.values.sn;
  var data = server.output;
  var url = "http://h18.korsimoro.com/assets/" + id + "/" + data.logo;
  return _react2.default.createElement(
    'div',
    { style: { border: "solid 1px white" } },
    _react2.default.createElement(
...
var _qrcode = __webpack_require__(59);
...
//# sourceMappingURL=static.b9f78745.js.map